...
export class MojangRestAPI {
    ...
    public static readonly AUTH_ENDPOINT = 'https://authserver.ely.by'
    ...
    public static async authenticate(
        ...
        try {
            ...
            const res = await MojangRestAPI.authClient.post<Session>('auth/authenticate', { json, responseType: 'json' })
    ...
    public static async validate(accessToken: string, clientToken: string): Promise<MojangResponse<boolean>> {
        ...
        try {
            ...
            const res = await MojangRestAPI.authClient.post('auth/validate', { json })
    ...
    public static async invalidate(accessToken: string, clientToken: string): Promise<MojangResponse<undefined>> {
        ...
        try {
            ...
            const res = await MojangRestAPI.authClient.post('auth/invalidate', { json })
    ...
    public static async refresh(accessToken: string, clientToken: string, requestUser = true): Promise<MojangResponse<Session | null>> {
        ...
        try {
            ...
            const res = await MojangRestAPI.authClient.post<Session>('auth/refresh', { json, responseType: 'json' })
